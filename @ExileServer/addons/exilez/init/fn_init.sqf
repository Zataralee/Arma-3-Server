...
MaxDistance			         = 60;              // Max distance to players before delete.
MaxTime                      = 1;               // Max time away from a player before delete.
...
EnableMoneyOnPlayer          = true;            // Money goes directly on killer
...
/* 8  MarkerBrush */         "Solid",            
/* 9  Marker Alpha */        0.5,                
/* 10 Marker Text */         "$2 Million Zombie Challenge!",     
/* 11 Vest group */          Basic,              
/* 12 Loot group */          DocAndAmmo,         
