...
[
	...
	"Exile_Trader_SpecialOperations",				//Will this work with a trader only
...
_msgStart = ['#FFFF00',format ["A Spec Ops trader has just reported in. Supplies are limited! Get there while you can!",getText (configFile >> "CfgVehicles" >> _class >> "displayName")]];

// Define Mission Win message
_msgWIN = ['#0080ff',format ["The Spec Ops trader has been found and is out of stock!"]];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"The Spec Ops trader can't wait forever! He is moving on. Better luck catching him next time!"];

// Define mission name (for map markers, mission messages, and logging)
_missionName = "Spec Ops Trader!";
