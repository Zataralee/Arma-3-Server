...
class CfgSettings
{
	...
	class Respect
	{
		...
		*/
		class Frags
		{
			domination = 200;			// Keeps killing the same guy
			letItRain = 150;			// MG, also vehicle MGs
			humiliation = 700;			// Axe
			passenger = 700;			// Out of car/chopper/boat
			roadKill = 200;				// :)
	...
	class BambiSettings
	{
		...
		spawnZoneVehicles[] =
		{
			{1, "C_Van_01_fuel_white_v2_F"},
			{1, "B_T_Truck_01_covered_F"},
			{1, "I_Truck_02_medical_F"},
			{1, "I_G_Offroad_01_armed_F"},
			{1, "O_G_Offroad_01_F"},
			{1, "B_T_LSV_01_unarmed_sand_F"},
			{1, "B_T_LSV_01_armed_F"}
		};
	};
	...
	class ServerSettings
	{
		...
		*/
		...
		devs[] = 
		{
			{"76561197994641119","[EXILE|DEV] Zataralee"}
		};
	};
