...
SC_VehicleClassToUse 		=   [	
									["Exile_Car_Hatchback_Rusty1",0],
									["Exile_Car_Hatchback_Rusty2",0],
									["Exile_Car_Hatchback_Rusty3",0],
									["Exile_Car_Golf_Black",0],
									["Exile_Car_Ikarus_Blue",0],
									["Exile_Car_Ural_Open_Worker",0],
									["Exile_Car_Ural_Open_Military",0],
									["CUP_B_Ural_Open_CDF",0],
									["CUP_B_Ural_Empty_CDF",0],
									["Exile_Car_Ural_Covered_Worker",0],
									["Exile_Car_Ural_Covered_Military",0],
									["CUP_B_MTVR_USA",0],
									["CUP_B_MTVR_USMC",0],
									["CUP_B_Ural_CDF",0],
									["CUP_B_MTVR_Ammo_USA",0],
									["CUP_B_MTVR_Refuel_USA",0],
									["CUP_B_MTVR_Repair_USA",0],
									["CUP_B_MTVR_Ammo_USMC",0],
									["CUP_B_MTVR_Refuel_USMC",0],
									["CUP_B_MTVR_Repair_USMC",0],
									["CUP_B_Ural_Refuel_CDF",0],
									["CUP_B_Ural_Repair_CDF",0],
									["CUP_B_Ural_Reammo_CDF",0],
									["Exile_Car_V3S_Open",0],
									["Exile_Car_V3S_Covered",0],
									["Exile_Car_SUVXL_Black",0],
									["Exile_Car_Octavius_White",0],
									["Exile_Car_Octavius_Black",0],
									["Exile_Car_UAZ_Green",0],
									["CUP_B_UAZ_Unarmed_CDF",0],
									["CUP_B_UAZ_Unarmed_ACR",0],
									["Exile_Car_UAZ_Open_Green",0],
									["CUP_B_UAZ_Open_ACR",0],
									["CUP_B_UAZ_Open_CDF",0],
									["Exile_Car_LandRover_Urban",0],
									["Exile_Car_LandRover_Green",0],
									["Exile_Car_LandRover_Sand",0],
									["Exile_Car_LandRover_Desert",0],
									["CUP_B_LR_Transport_CZ_W",0],
									["CUP_B_LR_Transport_CZ_D",0],
									["CUP_B_LR_Transport_GB_W",0],
									["CUP_B_LR_Transport_GB_D",0],
									["Exile_Car_LandRover_Ambulance_Desert",0],
									["Exile_Car_LandRover_Ambulance_Sand",0],
									["CUP_B_LR_Ambulance_CZ_W",0],
									["CUP_B_LR_Ambulance_CZ_D",0],
									["CUP_B_LR_Ambulance_GB_W",0],
									["Exile_Car_HEMMT",0],
									["Exile_Car_Offroad_Beige",0],
									["Exile_Car_Offroad_DarkRed",0],
									["Exile_Car_Offroad_BlueCustom",0],
									["Exile_Car_Offroad_Guerilla01",0],
									["Exile_Car_Offroad_Guerilla12",0],
									["Exile_Car_Offroad_Rusty1",0],
									["Exile_Car_Offroad_Repair_Civillian",0],
									["Exile_Car_Offroad_Repair_DarkRed",0],
									["Exile_Car_Offroad_Repair_BlueCustom",0],
									["Exile_Car_Offroad_Repair_Guerilla10",0],
									["Exile_Car_Offroad_Repair_Guerilla11",0],
									["Exile_Car_Offroad_Repair_Guerilla12",0],
									["Exile_Car_SUV_Red",0],
									["Exile_Car_SUV_Black",0],
									["Exile_Car_SUV_Grey",0],
									["Exile_Car_BTR40_Green",0],
									["Exile_Car_BTR40_Camo",0],
									["Exile_Car_HMMWV_MEV_Green",0],
									["Exile_Car_HMMWV_MEV_Desert",0],
									["Exile_Car_HMMWV_UNA_Green",0],
									["Exile_Car_HMMWV_UNA_Desert",0],
									["CUP_B_HMMWV_Unarmed_USMC",0],
									["CUP_B_HMMWV_Unarmed_USA",0],
									["CUP_B_HMMWV_Transport_USA",0],
									["CUP_B_HMMWV_Terminal_USA",0],
									["CUP_B_HMMWV_Ambulance_USMC",0],
									["CUP_B_HMMWV_Ambulance_USA",0],
									["CUP_B_HMMWV_Ambulance_ACR",0],
									["Exile_Car_Tempest",0],
									["Exile_Car_Van_Black",0],
									["Exile_Car_Van_Guerilla08",0],
									["Exile_Car_Van_Box_Black",0],
									["Exile_Car_Van_Box_Guerilla06",0],
									["Exile_Car_Van_Box_Guerilla07",0],
									["Exile_Car_Van_Box_Guerilla08",0],
									["Exile_Car_Van_Fuel_Black",0],
									["Exile_Car_Van_Fuel_Guerilla02",0],
									["Exile_Car_Van_Fuel_Guerilla03",0],
									["Exile_Car_Zamak",0],
									["Exile_Car_ProwlerLight",0],
									["Exile_Car_ProwlerUnarmed",0],
									["Exile_Car_QilinUnarmed",0],
									["Exile_Car_MB4WD",0],
									["Exile_Car_MB4WDOpen",0]
				                ];
