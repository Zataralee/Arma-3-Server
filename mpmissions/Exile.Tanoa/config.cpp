...
class CfgExileArsenal
{
	...
	#include "Traders\Items\Armory\Ammunition\prices.hpp"
	#include "Traders\Items\Armory\AssaultRifles\prices.hpp"
	#include "Traders\Items\Armory\BipodAttachments\prices.hpp"
	#include "Traders\Items\Armory\LMGs\prices.hpp"
	#include "Traders\Items\Armory\MuzzleAttachments\prices.hpp"
	#include "Traders\Items\Armory\OpticAttachments\prices.hpp"
	#include "Traders\Items\Armory\Pistols\prices.hpp"
	...
	#include "Traders\Items\Equipment\FirstAid\prices.hpp"
	#include "Traders\Items\Equipment\Glasses\prices.hpp"
	#include "Traders\Items\Equipment\Headgear\prices.hpp"
	#include "Traders\Items\Equipment\Uniforms\prices.hpp"
	#include "Traders\Items\Equipment\Vests\prices.hpp"
	#include "Traders\Items\Fast_Food\Drinks\prices.hpp"
	#include "Traders\Items\Fast_Food\Food\prices.hpp"
	#include "Traders\Items\Fast_Food\NonVeganFood\prices.hpp"
	#include "Traders\Items\Hardware\Hardware\prices.hpp"
	#include "Traders\Items\Hardware\Extended_Base_Mod\prices.hpp"
	#include "Traders\Items\Hardware\Tools\prices.hpp"
	#include "Traders\Items\Special_Operations\Explosives\prices.hpp"
	#include "Traders\Items\Special_Operations\Flares\prices.hpp"
	#include "Traders\Items\Special_Operations\Launchers\prices.hpp"
	#include "Traders\Items\Special_Operations\Navigation\prices.hpp"
	...
	class Exile_Magazine_5Rnd_127x108_APDS_KSVK			{ quality = 5; price = 40; };
	class Exile_Magazine_5Rnd_127x108_KSVK				{ quality = 5; price = 30; };
...
{
	ExileClient_gui_inventory_updateItemColors = "overrides\ExileClient_gui_inventory_updateItemColors.sqf";
...
class CfgTraderCategories
{
	...
	#include "Traders\Items\Armory\Ammunition\traders.hpp"
	#include "Traders\Items\Armory\AssaultRifles\traders.hpp"
	#include "Traders\Items\Armory\BipodAttachments\traders.hpp"
	#include "Traders\Items\Armory\LMGs\traders.hpp"
	#include "Traders\Items\Armory\MuzzleAttachments\traders.hpp"
	#include "Traders\Items\Armory\OpticAttachments\traders.hpp"
	#include "Traders\Items\Armory\Pistols\traders.hpp"
	...
	#include "Traders\Items\Equipment\FirstAid\traders.hpp"
	#include "Traders\Items\Equipment\Glasses\traders.hpp"
	#include "Traders\Items\Equipment\Headgear\traders.hpp"
	#include "Traders\Items\Equipment\Uniforms\traders.hpp"
	#include "Traders\Items\Equipment\Vests\traders.hpp"
	#include "Traders\Items\Fast_Food\Drinks\traders.hpp"
	#include "Traders\Items\Fast_Food\Food\traders.hpp"
	#include "Traders\Items\Fast_Food\NonVeganFood\traders.hpp"
	#include "Traders\Items\Hardware\Hardware\traders.hpp"
	#include "Traders\Items\Hardware\Extended_Base_Mod\traders.hpp"
	#include "Traders\Items\Hardware\Tools\traders.hpp"
	#include "Traders\Items\Special_Operations\Explosives\traders.hpp"
	#include "Traders\Items\Special_Operations\Flares\traders.hpp"
	#include "Traders\Items\Special_Operations\Launchers\traders.hpp"
	#include "Traders\Items\Special_Operations\Navigation\traders.hpp"
